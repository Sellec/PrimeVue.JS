    ...
    <div class="p-tabview p-component">
        <ul class="p-tabview-nav" role="tablist">
            <li role="presentation" v-for="(tab, i) of tabs" :key="tab.header || i" :class="[{'p-highlight': (tab.c_visible), 'p-disabled': tab.disabled, 'p-hidden': tab.hidden}]">
                <a role="tab" class="p-tabview-nav-link" @click="onTabClick($event, tab)" @keydown="onTabKeydown($event, tab)" :tabindex="tab.disabled ? null : '0'" :aria-selected="tab.c_visible">
