...
// CONCATENATED MODULE: ./src/components/datatable/DataTable.vue?vue&type=template&id=18753822&
...
function () {
  ...
  _createClass(FilterUtils, null, [{
    ...
    value: function startsWith(value, filter) {
      ...
      var filterValue = ObjectUtils_ObjectUtils.removeAccents(filter.toString()).toLowerCase();
      var stringValue = ObjectUtils_ObjectUtils.removeAccents(value.toString()).toLowerCase();
    ...
    value: function equals(value, filter) {
      ...
      if (value.getTime && filter.getTime) return value.getTime() === filter.getTime();else return ObjectUtils_ObjectUtils.removeAccents(value.toString()).toLowerCase() === ObjectUtils_ObjectUtils.removeAccents(filter.toString()).toLowerCase();
    }
  }, {
    key: "notEquals",
...
var Dropdown_component = normalizeComponent(
  ...
  Dropdownvue_type_template_id_14b4df7f_render,
  Dropdownvue_type_template_id_14b4df7f_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var TableHeadervue_type_script_lang_js_ = ({
  ...
  methods: {
    getColumnHeaderClass: function getColumnHeaderClass(column) {
      var sorted = this.sortMode === 'single' ? this.sortField && (this.sortField === column.field || this.sortField === column.sortField) : this.getMultiSortMetaIndex(column) > -1;
...
var TableHeader_component = normalizeComponent(
  ...
  TableHeadervue_type_template_id_009426d3_render,
  TableHeadervue_type_template_id_009426d3_staticRenderFns,
  false,
  null,
  null,
  null
...
var TableBody_component = normalizeComponent(
  ...
  TableBodyvue_type_template_id_9d494106_render,
  TableBodyvue_type_template_id_9d494106_staticRenderFns,
  false,
  null,
  null,
  null
